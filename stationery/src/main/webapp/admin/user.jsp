    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addUser">
                    <table class="table table-bordered table-striped" width="800px">
                        <tr>
                            <td>员工姓名</td>
                            <td><input class="form-control" placeholder="请输入姓名" id="adduname" onblur="checkVal()" onfocus="changeVal()" name="name"></td>
                            <td>邮箱</td>
                            <td><input class="form-control" placeholder="请输入邮箱" id="adduemail" onblur="checkVal()" onfocus="changeVal()"name="email"></td>
                        </tr>
                        <tr>
                            <td>入职时间</td>
                            <td><input type="date" class="form-control" name="hiredate" id="time"  onchange="checkVal()"></td>
                            <td>登录密码</td>
                            <td><input class="form-control" placeholder="请输入登录密码" id="addPw" onblur="checkVal()" onfocus="changeVal()" name="password"></td>
                        </tr>
						<tr>
							<td>用户角色</td>
							<td>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" data-dismiss="modal" aria-hidden="true" id="savemsg" disabled="true"
                        onclick="saveUser()">保存
                </button>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" data-dismiss="modal" aria-hidden="true" onclick="editUser()">保存</button>
                <button class="btn btn-default" data-dismiss="modal" aria-hidden="true">关闭</button>
            </div>
        </div>
    </div>
